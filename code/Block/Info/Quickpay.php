<?php
class Digidennis_QuickpayDolink_Block_Info_Quickpay extends Quickpay_Payment_Block_Info_Quickpay
{
    ...
    protected function getTheLink()
    {
        return Mage::helper('digidennis_quickpaydolink')->doLink($this->getInfo()->getOrder());
    }
}
